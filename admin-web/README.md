...
- 2026-07-10 기준 [bodeul110/bodeul-admin-web](https://github.com/bodeul110/bodeul-admin-web) 저장소는 생성됐지만, preview 검증과 source-of-truth 전환 전까지 이 디렉터리는 유지합니다.
- 별도 레포 분리 준비와 남은 전환 조건은 [관리자 웹 레포 분리 준비 계획](../docs/operations/admin-web-repository-split.md)을 따릅니다.
