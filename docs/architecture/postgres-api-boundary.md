...
| Spring Core API 인증 이관 | 개발 DB 검증 완료 | `core-api/src/main/java/com/bodeul/core/auth/`, Issue #157. `app_users` migration과 DB 권한 검증을 완료했고 Cloud Run preview 실제 token 검증은 후속 확인 필요 |
