...
날짜별 점검, 테스트, 문서/인코딩 정리 결과를 모아둔다. 현재 판단 기준 문서는 각 주제 디렉터리에 두고, 이 디렉터리는 실행 결과와 후속 기록을 보관한다.
...
- [전체 프로젝트 점검 후속 조치](project-check-followup-2026-06-20.md)
- [앱 테스트 준비](app-test-ready-2026-06-20.md)
- [실기기 테스트 보고서](device-test-report-2026-06-20.md)
- [관리자 액션/심사 검증 보고서](admin-action-test-report-2026-06-20.md)
- [인코딩 정리 후속 메모](encoding-cleanup-followup-2026-06-20.md)

## 같이 볼 문서

- [현재 구현 상태](../status/implementation-status.md)
- [내부 테스트 가이드](../operations/internal-test-guide.md)
- [보안 문서](../security/README.md)
