...
final class BookingHospitalSelectorLayoutPolicy {
    private static final float MIN_CONTENT_HEIGHT_WITH_REGIONS_DP = 460f;

    private BookingHospitalSelectorLayoutPolicy() {
    }

    static boolean showRegionShortcuts(int contentHeightPx, float density, float fontScale) {
