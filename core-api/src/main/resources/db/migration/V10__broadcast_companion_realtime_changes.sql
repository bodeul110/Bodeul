create function bodeul.broadcast_companion_realtime_change()
returns trigger
language plpgsql
security definer
...
create trigger broadcast_companion_chat_message_after_insert
after insert on bodeul.companion_chat_messages
for each row execute function bodeul.broadcast_companion_realtime_change();

create trigger broadcast_companion_read_receipt_after_change
after insert or update on bodeul.companion_chat_read_receipts
for each row execute function bodeul.broadcast_companion_realtime_change();

create trigger broadcast_companion_location_after_insert
after insert on bodeul.companion_session_locations
for each row execute function bodeul.broadcast_companion_realtime_change();
